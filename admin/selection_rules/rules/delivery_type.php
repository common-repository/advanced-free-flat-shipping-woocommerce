...
class Pi_efrs_selection_rule_delivery_type{
    public $slug;
    public $condition;
    ...
    function savedDropdown($html, $values, $count){
        if(self::datePluginInstalled()){
            $html = Pi_efrs_selection_rule_main::createSelect($this->deliveryTypes(),$count, $this->condition,  "", $values,'static');
            return $html;
        }
...
new Pi_efrs_selection_rule_delivery_type(PI_EFRS_SELECTION_RULE_SLUG);
