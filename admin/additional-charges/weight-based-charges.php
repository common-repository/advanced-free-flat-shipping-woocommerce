...
class pisol_efrs_weight_based_extra_charges_setting{
    ...
    function formData($data){
        ...
        if ( isset( $action_value ) && 'edit' === $action_value ) {
            ...
            $data['pi_efrs_cart_weight_sum_of_charges'] = get_post_meta($data['post_id'], 'pi_efrs_cart_weight_sum_of_charges', true);
            $data['pi_efrs_cart_weight_package_support'] = 'package';
        }else{
            $data['pi_enable_additional_charges_cart_weight']               = '';
            $data['pi_cart_weight_charges'] = '';
            $data['pi_efrs_cart_weight_sum_of_charges'] = 'all';
            $data['pi_efrs_cart_weight_package_support'] = 'package';
        }
        return $data;
    }
    ...
    function cloneData($data, $post_id){
            ...
            $data['pi_efrs_cart_weight_sum_of_charges'] = get_post_meta($post_id, 'pi_efrs_cart_weight_sum_of_charges', true);

            $data['pi_efrs_cart_weight_package_support'] = get_post_meta($post_id, 'pi_efrs_cart_weight_package_support', true);
    ...
    function extraCharges($post_id, $package){
        ...
        $cart_weight = self::getCartWeight($post_id, $package);
    ...
    static function getCharge($post_id, $get_charges, $cart_weight){
        ...
        $summing_method =  get_post_meta($post_id, 'pi_efrs_cart_weight_sum_of_charges', true);
    ...
    static function getCartWeight($post_id, $package){
        ...
        if($package_support == 'cart'){
            ...
            $weight = PISOL\EFRS\Package::get_weight($package);
        }
        return $weight;
    }
...
new pisol_efrs_weight_based_extra_charges_setting();
