...
v1.0.2
*/
if(!class_exists('pisol_affsw_advance_shipping_review')){
class pisol_affsw_advance_shipping_review{
...
new pisol_affsw_advance_shipping_review('Advance conditional shipping method plugin', 'advanced-free-flat-shipping-woocommerce', PI_EFRS_BUY_URL, PI_EFRS_PRICE);
}