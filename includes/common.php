...
if(!function_exists('pisol_efrs_revertToBaseCurrency')){
    function pisol_efrs_revertToBaseCurrency( $price ){
...
if(!function_exists('pisol_cefw_multiCurrencyFilters')):
    function pisol_efrs_multiCurrencyFilters($price){
        if( empty($price) ) return $price;
        /**
         * for doing currency conversion of fees for multiple currency plugin
         * https://wordpress.org/plugins/woo-multi-currency/
...
if(!function_exists('pisol_efrs_CurrencyValid')):
    function pisol_efrs_CurrencyValid($rule_id){
        $valid = true;
        ...
        $current_currency = apply_filters('pi_efrs_current_currency', get_woocommerce_currency());
